...
(function(dice) {
    ...
    this.selector_back_color = 0xd7d7d7;
    ...
    this.dice_box = function(container, dimentions) {
        ...
        var light = new THREE.SpotLight(that.spot_light_color);
        ...
        this.desk = new THREE.Mesh(new THREE.PlaneGeometry(this.w * 2, this.h * 2, 1, 1), 
                new THREE.MeshLambertMaterial({ color: that.desk_color }));
    ...
    this.dice_box.prototype.draw_selector = function() {
        this.clear();
        var step = this.w / 4.5;
        this.pane = new THREE.Mesh(new THREE.PlaneGeometry(this.cw * 2.1, this.ch * 2.1, 1, 1), 
                new THREE.MeshLambertMaterial({ color: that.selector_back_color }));
